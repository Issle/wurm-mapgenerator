...
This class demonstrates one of the hydraulic erosion algorithms described in Realtime Procedural Terrain Generation (http://oddlabs.com/download/terrain_generation.pdf)

*/

package com.oddlabs.procedurality;

public final class ExampleHydraulic {
	...
	public final static void main(String[] args) {
		...
		*/
		// let it rain for a couple of thousand years
 		height = ErosionHydraulic.erode1(height, height.copy().multiply(0.01f), 0.1f, 1, 100);
		...
		new Channel(size, size).add(0.5f).bump(height, 0.1f, 0f, 0.1f, 1f, 0f).normalize().toLayer().saveAsPNG("terrain7");
